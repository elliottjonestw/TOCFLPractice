import { allReadingQuestions } from "./bulkQuestions";
...
const starterReadingQuestions: Question[] = [
  // Band A: visual question formats
  {
    ...
    answer: "B",
    explanation: "句子說大家在游泳池游泳，所以應選游泳池的圖片。",
  },
  {
    id: "a-02",
    mode: "reading",
    ...
    visual: {
      kind: "image",
      src: "/images/questions/chinese-class.png",
      alt: "老師在教室裡上課，三位學生在聽",
    },
    options: [
      { id: "A", text: "教室裡有三位學生。" },
  ...
  },
  {
    ...
    passage:
      "我的室友跟我一樣大，__1__。因為我們都喜歡旅行，所以去年我們 __2__。那裡的天氣不冷也不熱，__3__。旅行的時候，我們照了 __4__。暑假快到了，我們正在想 __5__！",
  ...
  // Band B: grouped text and visual material
  {
    ...
    prompt: "請選出最適合填入空格的詞。",
    passage:
      "這家咖啡店不但環境安靜，__1__ 每天下午都有新鮮的麵包出爐，因此附近的學生很喜歡來這裡讀書。",
    options: [
      { id: "A", text: "雖然" },
      { id: "B", text: "而且" },
      { id: "C", text: "或者" },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "自己秤重後直接結帳" },
      { id: "B", text: "先把水果交給店員秤重" },
      { id: "C", text: "選盒裝水果" },
      { id: "D", text: "先拿塑膠袋" },
    ],
    answer: "B",
    explanation: "公告指示顧客先把水果放進籃子，再交給店員秤重。",
  },
  {
    id: "b-04",
    mode: "reading",
    ...
    answer: "A",
    explanation: "三個國家的社會住宅占比分別是 8%、6%、9%。",
  },
  {
    id: "b-05",
    mode: "reading",
    ...
    passage:
      "為了減少一次性杯子的使用，市立圖書館從下個月開始不再提供紙杯。館內設有飲水機，讀者可以自備水瓶。忘記帶水瓶的人，也能向服務台借用可重複使用的杯子。",
    options: [
      { id: "A", text: "圖書館會停止提供飲水。" },
      { id: "B", text: "讀者必須買水瓶。" },
      { id: "C", text: "讀者可以借用重複使用的杯子。" },
      { id: "D", text: "紙杯只能在服務台使用。" },
    ],
    answer: "C",
    explanation: "最後一句明確說明可向服務台借用杯子。",
  },
  ...
  // Band C: advanced passage and insertion formats
  {
    ...
    prompt: "請選出最適合填入空格的詞。",
    passage:
      "許多人將遠端工作視為提升效率的萬靈丹；__1__，彈性的工作地點也可能模糊了休息與工作的界線。",
    options: [
      { id: "A", text: "換言之" },
      { id: "B", text: "不過" },
      { id: "C", text: "因此" },
    ...
    answer: "B",
    explanation: "後句提出相反觀點，應使用轉折語「不過」。",
  },
  {
    id: "c-02",
    mode: "reading",
    ...
    answer: "II",
    explanation: "插入句延續「向奢華靠攏」的說法，接著才是對精品名牌的批評。",
  },
  {
    id: "c-03",
    mode: "reading",
    ...
    passage:
      "公共資料的開放常被理解為透明治理的同義詞，但資料是否真正可用，取決於它是否有足夠脈絡。若沒有清楚的蒐集方法、更新頻率與限制說明，再龐大的資料集也可能導向草率的結論。公開本身並非終點，而是讓公眾得以追問與檢驗的起點。",
    options: [
      { id: "A", text: "資料規模比說明重要。" },
      { id: "B", text: "政府不應公開原始資料。" },
      { id: "C", text: "資料公開需有脈絡，才能支持檢驗。" },
      { id: "D", text: "公開資料能避免所有錯誤。" },
    ],
    answer: "C",
    explanation: "文章強調脈絡與說明，讓公開成為檢驗的起點。",
  },
];
...
> = {
  A: {
    name: "Band A",
    label: "入門・基礎",
    description: "看圖、短文、選詞與生活情境",
  },
  B: {
    name: "Band B",
    label: "進階・高階",
    description: "選詞填空、公告、圖表與篇章閱讀",
  },
  C: {
    name: "Band C",
    label: "流利・精通",
    description: "篇章結構、句子插入與深度理解",
  },
};

// The starter records above document every supported format. The active bank is
// deliberately kept in one question-bank file while this file defines the
// shared data model used by Reading and future Listening content.
export const readingGroups: QuestionGroup[] = starterReadingGroups;
export const readingQuestions: Question[] = allReadingQuestions;
